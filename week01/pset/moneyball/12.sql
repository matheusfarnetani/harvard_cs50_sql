-- Hits are great, but so are RBIs! In 12.sql, write a SQL
-- query to find the players among the 10 least expensive
-- players per hit and among the 10 least expensive players
-- per RBI in 2001.
...
--     Order your results by player ID, least to greatest (or 
--     alphabetically by last name, as both are the same in this case!).
